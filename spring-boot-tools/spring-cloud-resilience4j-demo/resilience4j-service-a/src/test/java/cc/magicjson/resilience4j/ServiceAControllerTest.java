...
@SpringBootTest(classes = ServiceAApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class ServiceAControllerTest {
    ...
    public void testCallServiceB_Failure() {
        ...
        // 调用Service A的/call-b端点
        ResponseEntity<String> response = testRestTemplate.getForEntity("/call-b", String.class);
        // 验证响应状态和回退内容
        assertEquals(HttpStatus.OK, response.getStatusCode());
